...
dataset = getdata('filterdata/properati-AR-2013-08-01-properties-sell.csv')  #getdata function call with csv file as parameter
...
#import operator
#import math
#with open('data/properati-AR-2013-08-01-properties-sell.csv','rb') as f:
#    reader = unicodecsv.reader(f)
#    i_data = list(reader)
#    len(data)